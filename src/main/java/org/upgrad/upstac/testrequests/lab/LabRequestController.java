...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        return testRequestQueryService.findBy(RequestStatus.INITIATED); //way of accessing enum item is enum name.value
    ...
    public TestRequest updateLabTest(@PathVariable Long id,@RequestBody CreateLabResult createLabResult) {
        ...
        // Create an object of TestResult (TestRequest) class and make use of updateLabTest() method from testRequestUpdateService class
...
//            LabResult res = createLabResult(user,testrequest);
            return testrequest;
            //return null; // replace this line of code with your implementation
